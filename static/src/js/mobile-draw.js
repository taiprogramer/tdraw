document.addEventListener('DOMContentLoaded', () => {
    ...
    function render() {
        let optionWrapperHeight =
            document.querySelector('#option_wrapper').innerHeight
        ...
        document.querySelector('#undo').ontouchstart = () => {
            undoMode = true
            // get delayTime
        ...
        document.querySelector('#undo').ontouchend = () => {
            undoMode = false
        }
    }
